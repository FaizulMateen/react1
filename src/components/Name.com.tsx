...
const socialMediaLinks = [
    {
        name: 'GitHub',
        url: 'https://github.com/FaizulMateen/practise.git',
        icon: (
            <svg
    ...
    {
        name: 'Instagram',
        url: 'https://www.instagram.com/shaik____faizu/',
        icon: (
    ...
    {
        name: 'Twitter',
        url: 'https://twitter.com/Faizulmateen21?t=YRbVUCDOeuLHqoFMre-qqg&s=09',
        icon: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="50"
    ...
    {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/faizul-mateen-06a3b2238',
        icon: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="50"
