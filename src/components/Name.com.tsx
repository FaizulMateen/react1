...
const socialMediaLinks = [
    {
        name: 'GitHub',
        url: 'https://github.com/sameerahmed7/practice.git',
        icon: (
            <svg
    ...
    {
        name: 'Instagram',
        url: 'https://instagram.com/sameer___ahmed_7_9',
        icon: (
    ...
    {
        name: 'Facebook',
        url: 'https://www.facebook.com/profile.php?id=100042441757443',
        icon: (
    ...
    {
        name: 'Twitter',
        url: 'https://twitter.com/oyee_sam_7',
        icon: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="50"
    ...
    {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/sameer-ahmed-jan-717a22237',
        icon: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="50"
